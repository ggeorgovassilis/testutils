...
/**
 * <p>
 * Utility for writing simpler mockito {@link Answer}s. Just extend this class and implement a method that matches the mocked
 * method name and arguments. For example, if you want to mock </p>
 * <p><code>BankService.checkBalance(String accountId, Callback<BankAccount> callback)</code></p>
 * 
...
public abstract class BaseAnswer<T> implements Answer<T> {
	...
	private double rateMatch(Class<?>[] providedClasses,
	...
	public T answer(InvocationOnMock invocation) throws Throwable {
		...
		if (method == null)
			throw new RuntimeException(
					"This answer does not declare a method with these argument types: "
							+ argTypesToString(arguments));
